...
class MyTestCase(unittest.TestCase):
    ...
    def test_extractstores(self):
        extractor = StoreExtractor("/home/eran/Downloads/mechiron-downloads/2016-10-11_10_18_55")
        extractor.extract_stores_to_csv()
        # self.assertEqual(True, False)

    def test_extractprices(self):
        prices_extractor = PricesExtractor("/home/eran/Downloads/mechiron-downloads/2016-10-11_10_18_55")
